...
import edu.edo.torabentoapps.adapter.transaksiItemAdapter2;

/**
 * Created by anggy on 02/10/2017.
 */

public class historitransaksiclass extends AppCompatActivity {

    BootstrapEditText idtransaksi;
    BootstrapButton cari;
    RecyclerView rvTransaksi;
    RecyclerView.LayoutManager rvL;
    transaksiItemAdapter2 adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new transaksiItemAdapter2();
